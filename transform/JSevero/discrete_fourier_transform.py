...
frequencies = [35, 350, 3120, 3200, 3400, 3450]  # Frequencies of sine waves (Hz), with the last frequency now at 450 Hz
amplitudes = [2.4, 3.7, 1.6, 2.1, 3.4, 4.8]  # Corresponding amplitudes
