...
frequencies = [20, 80, 190, 260, 490, 500]  # Frequencies of sine waves (Hz), with the last frequency now at 450 Hz
amplitudes = [2.4, 3.8, 1.9, 2.7, 3.9, 4.3]  # Corresponding amplitudes
