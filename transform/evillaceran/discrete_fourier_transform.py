...
frequencies = [10, 40, 420, 150, 300, 540]  # Frequencies of sine waves (Hz), with the last frequency now at 450 Hz
amplitudes = [9.0, 11.0, 13.5, 7.5, 2.5, 6.0]  # Corresponding amplitudes
